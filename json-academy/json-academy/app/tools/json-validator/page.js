...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: { title: `${title} | JSON Academy`, description: tool.shortDesc, url: `https://www.jsonacademy.com/tools/json-validator`, type: "website" },
...
export default function Page() {
  ...
  const jsonLd = {
    ...
    url: `https://www.jsonacademy.com/tools/json-validator`,
  };
  return (
    <>
